<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="product6.aspx.cs" Inherits="Interior_Design_project.product6" %>
				...
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6 project-details-left">
							<img class="img-fluid" src="img/industrial5.jpg" alt="">
						</div>
						<div class="col-lg-6 project-details-right">
							<h3 class="pb-20"> Industrial Wall</h3>
							<p>the industrial home design style embraces exposed architectural elements like pipes, brick, and concrete, and minimalist design philosophy. </p>
